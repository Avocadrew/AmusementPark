...
//============================================================================
{
	...
	points.clear();
	points.push_back(ControlPoint(Pnt3f(80, 15, 0)));
	points.push_back(ControlPoint(Pnt3f(0, 25, 70)));
	points.push_back(ControlPoint(Pnt3f(-70, 55, 0)));
	points.push_back(ControlPoint(Pnt3f(0, 45, -80)));
